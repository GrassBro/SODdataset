...
**MSRA-1000**|Frequency-tuned Salient Region Detection, **CVPR 2009**.|[Homepage](https://ivrlwww.epfl.ch/supplementary_material/RK_CVPR09/) |BSD300, VOC dataset and internet.| Complex Scene Saliency Dataset(CSSD).
